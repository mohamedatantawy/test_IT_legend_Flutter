...
import 'package:it_test/feature/Plans%20Selected/presentation/view/PlansSelectedView.dart';
  ...
  Widget build(BuildContext context) {
    Widget getBody() {
      switch (_selectedIndex) {
        case 4:
          return const PlansSelectedView();
        case 0:
                  ...
                  return GestureDetector(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (_selectedIndex ==
                            index) // Underline for selected item
                          Container(
                            decoration: BoxDecoration(
